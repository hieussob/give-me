...
export const medicines = [
  ...
  },
  {
    ...
    family: "Họ Cúc (Asteraceae)",
    categoryId: "asteraceae",
    image: "https://images.unsplash.com/photo-1602524206684-fbd6abb5f367?w=800",
  ...
  },
  {
    ...
    family: "Họ Cần tây (Apiaceae)",
    categoryId: "apiaceae",
    image: "https://images.unsplash.com/photo-1591361315493-e4e275e7f3f4?w=800",
    usedParts: "Root (Radix Angelicae sinensis) - Harvest in autumn when leaves wither, remove fibrous roots, dry in shade",
    properties: "Sweet, pungent taste, warm nature",
    meridians: "Liver, Heart, Spleen meridians",
    mainIngredients: ["Essential oil 0.2-0.4% (ligustilide, butylidenephthalide)", "Ferulic acid", "Polysaccharide", "Organic acid", "Coumarins"],
    uses: ["Tonifies blood regulates menstruation", "Activates blood eliminates stasis", "Moistens intestines relieves constipation", "Stops pain"],
    indications: ["Irregular menstruation", "Amenorrhea dysmenorrhea", "Blood deficiency", "Anemia", "Postpartum abdominal pain", "Constipation due to blood deficiency", "Wind-dampness joint pain"],
    dosage: "Dried root: 6-15g decoction. Can soak in wine make pills powder. Angelica head tonifies blood, body harmonizes blood, tail activates blood",
    contraindications: ["Pregnant women use with caution", "People with diarrhea use with caution", "People with excessive menstruation use with caution"],
    origin: "Vietnam (cultivated in northern mountainous provinces). China, Korea",
    description: "Duong Quy (also called Đương quy) is a perennial herbaceous plant of the Apiaceae family 40-100cm tall. Root large, fleshy, branching, brown outside, white inside, aromatic. Stem erect, purple-red. Basal leaves 2-3 pinnate compound. Umbel compound inflorescence, white flowers. Double achene fruit. Contains essential oil (ligustilide main component), ferulic acid, polysaccharide. Sweet pungent taste, warm nature. Has effects tonifying blood regulating menstruation, activating blood eliminating stasis, moistening intestines. Treats irregular menstruation, amenorrhea, dysmenorrhea, blood deficiency, anemia, postpartum abdominal pain, constipation, joint pain. Is very important blood-tonifying herb in traditional medicine, especially for women."
  },
  {
    id: 63,
    name: "Gao",
    ...
    usedParts: "Rice grain (milled or unmilled), rice sprouts (germinated rice), rice bran",
    properties: "Sweet taste, neutral nature",
    meridians: "Spleen, Stomach meridians",
    mainIngredients: ["Starch 70-80%", "Protein 6-8%", "Fat 0.5-1%", "Vitamin B1, B2", "Minerals (iron, zinc, magnesium)"],
    uses: ["Tonifies middle qi", "Strengthens spleen stomach", "Supplements nutrition", "Stops diarrhea"],
    indications: ["Qi deficiency fatigue", "Loss of appetite", "Spleen deficiency diarrhea", "Malnutrition"],
    dosage: "Rice: Cook into porridge or rice to eat. Rice sprouts: 15-30g decoction to aid digestion. Rice bran: Can extract oil supplement nutrition",
    contraindications: ["People with diabetes use with caution (high starch)", "People with indigestion use with caution when eating sticky rice"],
    origin: "Vietnam (cultivated widely nationwide as main food source). Asia",
    description: "Gao (rice) is the main grain crop of the Poaceae family, is staple food for majority of Vietnamese and Asian people. Rice grain after milling becomes white rice, retaining bran becomes brown rice. Contains mainly starch, protein, vitamins B group, minerals. Sweet taste, neutral nature. Has effects tonifying middle qi, strengthening spleen stomach, supplementing nutrition. Rice porridge is light food, suitable for digestive system recovery, treating spleen deficiency diarrhea. Rice sprouts (germinated rice) aids digestion, relieves food stagnation. Rice bran contains oil and many nutrients, can extract oil for eating. Rice is not only food but also important medicine in traditional medicine."
  },
  {
    id: 64,
    name: "Gao Luc",
    firstLetter: "G",
    scientificName: "Oryza sativa L. var. glutinosa",
    family: "Họ Lúa (Poaceae)",
    categoryId: "poaceae",
    image: "https://images.unsplash.com/photo-1536304929831-eab97306b1f7?w=800",
    usedParts: "Glutinous rice grain (milled or unmilled). Harvest when rice plant is ripe, thresh, dry, store",
    properties: "Sweet taste, warm nature",
    meridians: "Spleen, Stomach, Lung meridians",
    mainIngredients: ["Amylopectin (makes rice sticky)", "Protein", "Fat", "Vitamin B group", "Minerals"],
    uses: ["Tonifies middle qi", "Warms spleen stomach", "Stops diarrhea", "Stops perspiration"],
    indications: ["Spleen stomach deficiency cold", "Diarrhea", "Spontaneous perspiration", "Night sweats", "Thirst frequent urination"],
    dosage: "Glutinous rice: Cook into porridge or sticky rice to eat. Can make medicinal alcohol soak herbs. Roasted glutinous rice flour: 10-20g eat to stop diarrhea",
    contraindications: ["People with diabetes use with caution (high sugar)", "People with indigestion use with caution (sticky rice difficult to digest)", "People with dampness-heat use with caution"],
    origin: "Vietnam (cultivated widely nationwide). Asia",
    description: "Gao Luc (glutinous rice, also called Gạo nếp) is a variety of rice of the Poaceae family, grain after cooking becomes very sticky due to high amylopectin content. Sweet taste, warm nature. Has effects tonifying middle qi, warming spleen stomach, stopping diarrhea perspiration. Treats spleen stomach deficiency cold, diarrhea, spontaneous perspiration, night sweats. Glutinous rice can make porridge easier to digest than sticky rice. Roasted glutinous rice flour stops diarrhea effectively. Glutinous rice also used to make medicinal alcohol to soak medicinal herbs. However glutinous rice is sticky, difficult to digest, people with weak digestive system or diabetes need to use with caution."
  },
  {
    id: 65,
    name: "Gat Neo",
    ...
    categoryId: "convolvulaceae",
    image: "https://images.unsplash.com/photo-1598030430234-6d5846aab1e3?w=800",
    usedParts: "Above-ground parts (Herba Ipomoeae aquaticae) - Use fresh, harvest year-round",
    properties: "Sweet taste, cold nature",
    meridians: "Liver, Large Intestine meridians",
    mainIngredients: ["Protein", "Vitamins A, C, B", "Minerals (iron, calcium, phosphorus)", "Fiber", "Carotenoid"],
    uses: ["Clears heat detoxifies", "Cools blood stops bleeding", "Moistens intestines relieves constipation", "Diuretic"],
    indications: ["Nosebleed", "Hemoptysis", "Hematuria", "Hemorrhoids bleeding", "Constipation", "Food poisoning", "Skin infections"],
    dosage: "Fresh vegetable: 100-200g boil or stir-fry eat. For medicinal use: 30-60g decoction. Fresh juice for external use on skin infections",
    contraindications: ["People with spleen-stomach deficiency cold use with caution (cold nature)", "People with diarrhea should not eat much"],
    origin: "Vietnam (grows wild and cultivated widely as popular vegetable). Tropical Asia",
    description: "Gat Neo (also called Rau muống) is a creeping or floating aquatic herbaceous plant of the Convolvulaceae family. Stem hollow, can grow on water or moist soil. Leaves alternate, arrow-shaped or heart-shaped, entire margin. Flowers funnel-shaped, white or light purple. Contains many vitamins and minerals, especially vitamin A, C and iron. Sweet taste, cold nature. Has effects clearing heat detoxifying, cooling blood stopping bleeding, moistening intestines. Treats nosebleed, hemoptysis, hemorrhoids bleeding, constipation, food poisoning. Is popular nutritious vegetable in Vietnamese meals, also effective folk remedy."
  },
  {
    id: 66,
    name: "Gung",
    ...
    usedParts: "Fresh rhizome (Rhizoma Zingiberis recens), dried rhizome (Rhizoma Zingiberis), charred ginger (Rhizoma Zingiberis praeparatum)",
    properties: "Pungent taste, warm nature (fresh ginger slightly warm, dried ginger hot, charred ginger warm)",
    meridians: "Spleen, Stomach, Lung meridians",
    mainIngredients: ["Essential oil 1-3% (gingerol, zingiberene, shogaol)", "Phenolic compounds (gingerol, shogaol)", "Resin", "Starch"],
    uses: ["Relieves exterior disperses cold", "Warms middle stops vomiting", "Warms lungs stops cough", "Detoxifies"],
    indications: ["Wind-cold common cold", "Nausea vomiting", "Cough with thin phlegm", "Food poisoning", "Abdominal pain diarrhea due to cold"],
    dosage: "Fresh ginger: 3-10g or 3-5 slices in decoction. Dried ginger: 3-9g decoction. Charred ginger: 3-6g decoction to stop bleeding warm channels",
    contraindications: ["People with yin deficiency fire excess use with caution", "Pregnant women with hot constitution use with caution", "People with hemorrhoids bleeding should not use"],
    origin: "Vietnam (cultivated widely nationwide). Tropical Asia",
    description: "Gung (ginger) is a perennial herbaceous plant of the Zingiberaceae family. Rhizome thick, fleshy, yellow inside, very aromatic pungent. Stem erect 50-100cm. Leaves alternate, lanceolate. Spike inflorescence, yellow-green flowers. Contains essential oil (gingerol, shogaol main components). Fresh ginger has pungent taste slightly warm nature, relieves exterior disperses cold, warms middle stops vomiting, detoxifies. Dried ginger pungent taste hot nature, warms middle disperses cold, restores yang rescues collapse. Charred ginger warms channels stops bleeding. Treats wind-cold, nausea, vomiting, cough, food poisoning, abdominal pain diarrhea. Ginger is both common spice and important medicine."
  },
  {
    id: 67,
    name: "Hanh",
    ...
    family: "Họ Hành tỏi (Amaryllidaceae)",
    categoryId: "amaryllidaceae",
    image: "https://images.unsplash.com/photo-1618512496248-a07fe83aa8cb?w=800",
    usedParts: "White part of stem (Bulbus Allii fistulosi) - Harvest year-round, use fresh or sun dry",
    properties: "Pungent taste, warm nature",
    meridians: "Lung, Stomach meridians",
    mainIngredients: ["Essential oil (allyl sulfide)", "Allicin", "Vitamins C, B", "Minerals", "Flavonoid"],
    uses: ["Induces perspiration relieves exterior", "Disperses cold unblocks yang", "Detoxifies kills parasites"],
    indications: ["Wind-cold common cold", "Fever chills", "Headache nasal congestion", "Abdominal pain due to cold", "Urinary retention", "Dysentery"],
    dosage: "White part fresh: 10-30g decoction or eat raw. Can mash apply externally for abscesses boils. Use white part for medicine, green leaves for food",
    contraindications: ["People with exterior deficiency perspiration use with caution", "People with yin deficiency fire excess use with caution"],
    origin: "Vietnam (cultivated widely). Asia",
    description: "Hanh (scallion, also called Hành lá) is a perennial herbaceous plant of the Amaryllidaceae family. Small bulb, cylindrical hollow leaves. White part of stem contains essential oil (allyl sulfide main component), allicin with antibacterial effects. Pungent taste, warm nature. Has effects inducing perspiration relieving exterior, dispersing cold unblocking yang, detoxifying. Treats wind-cold common cold with fever chills headache nasal congestion, abdominal pain due to cold, urinary retention, dysentery. White part used for medicine stronger effects than green leaves. Can mash apply externally for abscesses boils. Is both common spice and folk remedy."
  },
  {
    id: 68,
    name: "Hanh Tay",
    ...
    family: "Họ Hành tỏi (Amaryllidaceae)",
    categoryId: "amaryllidaceae",
    image: "https://images.unsplash.com/photo-1518977822534-7049a61ee0c2?w=800",
    usedParts: "Bulb (fresh or dried). Harvest when bulb is fully developed, remove outer dry layers, use fresh or dry",
    properties: "Pungent taste, warm nature",
    meridians: "Lung, Stomach, Liver meridians",
    mainIngredients: ["Essential oil (allyl sulfide, allyl propyl disulfide)", "Quercetin", "Sulfur compounds", "Vitamins C, B", "Minerals"],
    uses: ["Disperses cold relieves exterior", "Regulates qi harmonizes stomach", "Detoxifies kills parasites", "Lowers blood pressure"],
    indications: ["Wind-cold common cold", "Indigestion", "Abdominal distension", "Hypertension", "Hyperlipidemia", "Diabetes support"],
    dosage: "Fresh bulb: 30-60g eat raw or cooked as food. For medicinal decoction: 10-20g. External use: mash apply on insect bites",
    contraindications: ["People with eye diseases use with caution (pungent damages eyes)", "People with yin deficiency fire excess use with caution", "People with stomach ulcers use with caution when eating raw"],
    origin: "Vietnam (cultivated widely). Central Asia, Mediterranean region",
    description: "Hanh Tay (onion, also called Hành tím, Hành củ) is a biennial herbaceous plant of the Amaryllidaceae family. Large bulb, spherical, layered, purple-red or white. Cylindrical hollow leaves. Umbel inflorescence, small white flowers. Contains essential oil (allyl sulfide main component), quercetin with antioxidant effects, sulfur compounds with antibacterial properties. Pungent taste, warm nature. Has effects dispersing cold, regulating qi harmonizing stomach, detoxifying, lowering blood pressure and blood lipids. Treats wind-cold, indigestion, abdominal distension. Modern research shows onion helps prevent cardiovascular diseases, diabetes. Is both popular food and effective folk remedy."
  },
  {
    id: 69,
    name: "He",
    ...
    usedParts: "Leaves (Herba Allii tuberosi), seeds (Semen Allii tuberosi) - Harvest leaves year-round, harvest seeds in autumn when ripe",
    properties: "Pungent taste, warm nature",
    meridians: "Liver, Kidney, Stomach meridians",
    mainIngredients: ["Essential oil (allyl sulfide)", "Vitamins A, C, B", "Minerals (iron, calcium)", "Fiber", "Allicin"],
    uses: ["Warms middle promotes qi", "Tonifies kidney strengthens yang", "Activates blood disperses stasis", "Stops bleeding"],
    indications: ["Kidney deficiency impotence", "Spermatorrhea premature ejaculation", "Urinary frequency enuresis", "Abdominal pain diarrhea due to cold", "Traumatic bleeding"],
    dosage: "Fresh leaves: 50-100g cook eat as vegetable. Seeds: 3-9g decoction to tonify kidney. External use: fresh leaves mash apply on wounds to stop bleeding",
    contraindications: ["People with yin deficiency fire excess use with caution", "People with eye diseases should not eat much (pungent damages eyes)", "People with stomach heat use with caution"],
    origin: "Vietnam (cultivated widely). Asia",
    description: "He (Chinese chives, also called Củ kiệu) is a perennial herbaceous plant of the Amaryllidaceae family. Small bulb, flat leaves like grass, strong aroma. Umbel inflorescence, small white flowers. Black angular seeds. Contains essential oil (allyl sulfide), vitamins, minerals. Pungent taste, warm nature. Has effects warming middle promoting qi, tonifying kidney strengthening yang, activating blood dispersing stasis. Treats kidney deficiency impotence, spermatorrhea, urinary frequency, enuresis, abdominal pain diarrhea. Seeds (called Hạt củ kiệu) tonify kidney strengthen yang stronger than leaves. Fresh leaves can mash apply on wounds to stop bleeding. Is both nutritious vegetable and kidney-tonifying medicine."
  },
  {
    id: 70,
    name: "Hoa Nhai",
    ...
    categoryId: "oleaceae",
    image: "https://images.unsplash.com/photo-1592334873274-ec4d49e5c7c3?w=800",
